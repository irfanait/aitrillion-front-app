...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
 ...
 <body style="margin:0; padding:0; background-color:#f6f6f6;">
                        ...
                        <tbody>
                            ...
                            <td class="esd-structure es-p20t es-p20r es-p20l" align="left">
                              <!--[if mso]>
                                <table width="560" cellpadding="0" cellspacing="0">
                                  <tr><td width="180" valign="top"><![endif]-->
                          ...
                          <tr>
                            <td class="esd-structure es-p20t es-p20b es-p20r es-p20l" align="left">
                              <!--[if mso]>
                                <table width="560" cellpadding="0" cellspacing="0"><tr><td width="270" valign="top"><![endif]-->
                          ...
                          <tr class="cust_unsubscribe">
                            <td class="esd-structure es-p20t es-p20b es-p5r es-p5l" align="left">
                              <table cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
                                  <tr>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-text">
                                              <p style="color: #999999;">
                                                ...
                                                <a target="_blank" href="{%unsubscribe_link%}">Unsubscribe</a>
                                              </p>
                                            </td>
                                          </tr>
                                        </tbody>
  ...
  css: `
/* Default paddings */
.es-p-default { padding-top: 20px; padding-right:5px; padding-bottom: 20px; padding-left:5px;}
#outlook a {padding: 0;}
